var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            alignment: 'center',
            hidden: false,
            description2: "The above analysis of the basic demographic data shows that although bike-sharing can be used as a mode of transportation for commuting and recreation, the distribution of bike lanes in D.C. is not comprehensive. The inequities in the distribution of bike lanes and bike-sharing stations have always been a serious issue. While people without cars are more likely to take bike share and other forms of public transportation, their accessibility to these facilities is worrisome. Thus, it's important to further understand the activity patterns of groups who use bike-sharing and the commuting and recreational travel patterns of people without cars or in low-income households. At the same time, the analysis attempts to further reveal inequalities in geospatial and facility distribution, with the aim of making recommendations for a better infrastructure setup.",
            image3: 'images/Change of NoVehicle Households.jpeg',
